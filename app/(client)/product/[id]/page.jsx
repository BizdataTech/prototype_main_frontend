...
const Productpage = () => {
  ...
  return product ? (
    ...
    <div className="w-[95%] mx-auto flex flex-col md:flex-row gap-6 pt-[12rem] pb-12">
      <div className="shimmer w-full md:w-3/6 h-[30rem] md:h-[50rem]"></div>
      <div className="w-full md:w-3/6 space-y-3">
        <div className="shimmer w-full h-[5rem]"></div>
        <div className="shimmer w-[60%] md:w-[30%]"></div>
